...
const Education = () => (
  ...
  >
    ...
    >
      ...
      <ul>
        <li>
          <strong>Inhalation:</strong> Smoking or vaping flower and
          concentrates offers rapid onset (minutes) but may irritate lungs.
        </li>
        <li>
      ...
      <p>Terpenes are aromatic compounds giving each strain its unique scent and potential therapeutic effects:</p>
      <ul>
      ...
      <p><strong>Indica:</strong> Often associated with body relaxation, pain relief, and sleep aid. Best for nighttime use.</p>
      <p><strong>Sativa:</strong> Tends to produce uplifting, energizing effects. Ideal for daytime activities and creativity.</p>
      <p><strong>Hybrid:</strong> Crossbreeds combining characteristics of both indica and sativa to balance effects.</p>
      ...
      <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 text-[white] font-bold animate-bounce pointer-events-none">
        ↓ Scroll ↓
      </div>
